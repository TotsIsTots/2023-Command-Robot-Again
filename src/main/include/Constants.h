...
constexpr int kRearLeftDriveMotorPort = 4;
constexpr int kFrontRightDriveMotorPort = 7;
...
constexpr int kFrontRightTurningMotorPort = 8;
constexpr int kRearRightTurningMotorPort = 11;

constexpr int kFrontLeftTurningEncoderPort = 3;
constexpr int kRearLeftTurningEncoderPort = 6;
constexpr int kFrontRightTurningEncoderPort = 9;
constexpr int kRearRightTurningEncoderPort = 12;
...
constexpr double kWheelRadius = 0.047625;
...
constexpr auto kMaxAcceleration = 2.2_mps_sq;
constexpr auto kMaxAngularSpeed = 6.288_rad_per_s;
